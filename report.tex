...
\begin{enumerate}
    ...
    \item Realistic noise modeling including 2\% mass variance, 5\% thrust noise, and 1\% attachment point geometric uncertainties
...
\begin{itemize}
    ...
    \item Maximum thrust per drone: $T_{\max} = \frac{9g}{0.7} \approx \SI{126}{N}$ (90\% of hover at 70\% throttle)
...
Simulation duration & $T_{\text{sim}}$ & \SI{45}{s} \\
