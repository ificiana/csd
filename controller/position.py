...
class PositionController:
    ...
    def compute_force(self, pos: np.ndarray, vel: np.ndarray, 
                      pos_ref: np.ndarray, vel_ref: np.ndarray) -> np.ndarray:
        """
        ...
        desired_acceleration = KP @ position_error + KD @ velocity_error + KI_POS @ self.integral_error
