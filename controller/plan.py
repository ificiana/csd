...
from config import EAST, HEIGHT, HOVER_TIMES, NORTH, POSITION_TOLERANCE
...
class TrajectoryPlanner:
    ...
    def __init__(self, payload_half_height: float, 
                 z_coeff: float, x_coeff: float, y_coeff: float,
    ...
    def get_reference_position(self) -> np.ndarray:
        ...
        match self.phase:
            ...
            case 2:
                return np.array([quintic.position(self.x_coeff, self.travel_e, t), 0.0, H])
            case 3:
    ...
    def get_reference_velocity(self) -> np.ndarray:
        ...
        match self.phase:
            ...
            case 2:
                return np.array([quintic.velocity(self.x_coeff, self.travel_e, t), 0.0, 0.0])
            case 3:
                return np.array([0.0, 0.0, 0.0])
            case 4:
    ...
    def get_feedforward_acceleration(self, pos: np.ndarray, gravity: float) -> tuple[float, float, float]:
        """
