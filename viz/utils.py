...
from config import DRONE_MAX_THRUST, MAX_TAKEOFF_FRACTION, MAX_TRANSL_FRACTION
    ...
    *,
    ...
    if traj:
        ...
        if len(cols) == 2:
            ...
            if bw:
                layout_dict_2d["title"] = {
                    "text": layout_dict_2d["title"],
                ...
                layout_dict_2d["xaxis"] = {
                    "showgrid": True,
                    "gridcolor": grid_color,
                    "zeroline": True,
                    "zerolinecolor": zero_color,
                }  # type: ignore
                layout_dict_2d["yaxis"] = {
                    "showgrid": True,
                    "gridcolor": grid_color,
                    "zeroline": True,
                    "zerolinecolor": zero_color,
            ...
            if bw:
                layout_dict_3d["title"] = {
                    "text": layout_dict_3d["title"],
                    "font": {"size": 16, "color": text_color},
                }  # type: ignore
    ...
    if merge:
        ...
        if bw:
            layout_dict_merge["title"] = {
                "text": layout_dict_merge["title"],
                "font": {"size": 16, "color": text_color},
            }  # type: ignore
            ...
            layout_dict_merge["xaxis"] = {
                "showgrid": True,
                "gridcolor": grid_color,
                "zeroline": True,
                "zerolinecolor": zero_color,
            }  # type: ignore
            layout_dict_merge["yaxis"] = {
                "showgrid": True,
                "gridcolor": grid_color,
                "zeroline": True,
                "zerolinecolor": zero_color,
        ...
        if bw:
            layout_dict_sub["title"] = {
                "text": layout_dict_sub["title"],
                "font": {"size": 16, "color": text_color},
            }  # type: ignore
...
def plot_graphs(data: Data, bw: bool = False):
    ...
    for cols, title, traj, ylabel in cube_plots:
        plot_time_series(
            data.cube.df, cols, title=title, traj=traj, ylabel=ylabel, bw=bw
        )
